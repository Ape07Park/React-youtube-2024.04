...
export const useChannelInfo = id => {
  const uri = `https://youtube.googleapis.com/youtube/v3/channels?id=${id}&key=${process.env.REACT_APP_YOUTUBE_API_KEY}&part=snippet,statistics`; // channel id 넣으면 구독자 수 나옴
